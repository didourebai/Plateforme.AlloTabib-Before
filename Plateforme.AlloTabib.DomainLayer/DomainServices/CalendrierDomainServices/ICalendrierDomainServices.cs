...
{
    public interface ICalendrierDomainServices
    {
        ResultOfType<CalendrierResultModel> GetCalendrierParPraticienAndDate(ConfigurationPraticien configurationPraticien, DateTime? dateSelected);
