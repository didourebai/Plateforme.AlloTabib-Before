        ...
        praticienApiServices.getPraticienByEmail(mail)
            .then(
                ...
                function (results) {
                    ...
                    if ($scope.udpatePraticien != undefined && $scope.udpatePraticien.conventionne != undefined) {
                        if ($scope.udpatePraticien.conventionne == 'True')
                            $scope.udpatePraticien.conventionne = true;
                        else
                            $scope.udpatePraticien.conventionne = false;
                    }
                },
                // Case : Error.
                function (error) {
