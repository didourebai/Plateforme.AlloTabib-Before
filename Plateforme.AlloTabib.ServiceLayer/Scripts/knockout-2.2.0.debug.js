...
ko.templateEngine.prototype['makeTemplateSource'] = function(template, templateDocument) {
    ...
    } else if ((Plateforme.AlloTabib.nodeType == 1) || (Plateforme.AlloTabib.nodeType == 8)) {
        // Anonymous template
...
(function() {
    // A template source represents a read/write way of accessing a Plateforme.AlloTabib. This is to eliminate the need for template loading/saving
    ...
    ko.templateSources.anonymousPlateforme.AlloTabib.prototype = new ko.templateSources.domElement();
    ko.templateSources.anonymousPlateforme.AlloTabib.prototype['text'] = function(/* valueToWrite */) {
        if (arguments.length == 0) {
