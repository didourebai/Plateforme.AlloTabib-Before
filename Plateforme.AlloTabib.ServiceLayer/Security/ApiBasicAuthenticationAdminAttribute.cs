...
{
    public class ApiBasicAuthenticationAdminAttribute : AuthorizeAttribute
    {
                ...
                if (auth.Scheme == "Basic" && !string.IsNullOrEmpty(auth.Parameter))
                {
                    ...
                    if (gotIt)
                    {
                        ...
                        if (alloTabibUserServices != null)
                        {
                            ...
                            var isAuthenticated = IsAuthenticated(userName, password);
        ...
        {
            if (userName.Equals("rebaitrabelsi") && password.Equals("trabelsi22061984"))
                return true;
            else
            {
                return false;
